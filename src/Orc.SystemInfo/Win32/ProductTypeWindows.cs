namespace Orc.SystemInfo.Win32
{
    ...
    {
        public Dictionary<int, string> ProductType = new Dictionary<int, string>
        {
            {0x00000006, "Business"},
            ...
            {0x00000008,"Server Datacenter (full installation. For Server Core installations of Windows Server 2012 and later, use the method, Determining whether Server Core is running.)"},
            ...
            {0x00000007,"Server Standard (full installation. For Server Core installations of Windows Server 2012 and later, use the method, Determining whether Server Core is running.)"},
